...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#fff] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        @livewire('schema-visualizer.tables')
        <div class="mermaid">
            %%{
              init: {
                'theme': 'base',
            ...
            classDiagram
                class SchemaVisualizerService {
                    ...
                    +compareWithMigrations()
                }

                class TablesLivewire {
                    +tables: array
                ...
                class SchemaVisualizerProvider {
                    +register()
                    +boot()
                }
                ...
                SchemaVisualizerService -- Table: "1..*"
                SchemaVisualizerService -- Column: "1..*"
